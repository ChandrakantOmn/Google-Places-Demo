...
public class AutoAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    private ArrayList<AutocompletePrediction> mResultList;
    private PlacesClient placesClient;

    AutoAdapter(Context context, PlacesClient placesClient) {
...
//                        .setLocationRestriction(bounds)
        ...
        if (results.isSuccessful()) {
            if (results.getResult() != null) {
                Log.e("RESPONSE", results.getResult().getAutocompletePredictions().toString());
